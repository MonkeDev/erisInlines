    ...
    wsEvent(packet) {
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "MESSAGE_REACTION_ADD": {
                ...
                * @prop {Member | Object} reactor The member, if the reaction is in a guild. If the reaction is not in a guild, this will be null.
                */
                this.emit("messageReactionAdd", message, packet.d.emoji, packet.d.user_id, packet.d.user_id, member || null);
                break;
            }
